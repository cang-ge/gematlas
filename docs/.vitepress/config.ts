...
export default defineConfig({
  ...
  head: [
    ...
    [
      ...
      {
        rel: 'stylesheet',
        href: 'https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,400;0,500;0,600;0,700;1,400&family=Inter:wght@400;500;600;700&family=Noto+Serif+SC:wght@200;300;400;500;600;700&display=swap',
      },
    ],
  ],
